...
curl -X POST -H "Content-Type:application/json" -d '{"name": "piBeacon A", "beaconGUID": "87209302-C7F2-4D56-B1D1-14EADD0CE41F", "beaconGUIDMinor": 1,  "beaconGUIDMajor": 1 }' http://localhost:3000/api/ibeacons;
curl -X POST -H "Content-Type:application/json" -d '{"name": "Product B", "beaconGUID": "958AAA05-744A-4924-95D5-2195B5F1EE95", "beaconGUIDMinor": 1,  "beaconGUIDMajor": 1}' http://localhost:3000/api/ibeacons;
